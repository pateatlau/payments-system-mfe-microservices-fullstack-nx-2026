    ...
    return (
      <input
        ...
        className={cn(
          ...
          'dark:border-[rgb(var(--border))] dark:bg-[rgb(var(--background))] dark:text-[rgb(var(--foreground))] dark:placeholder:text-[rgb(var(--muted-foreground))] dark:focus:ring-[rgb(var(--primary))]',
          className
        )}
        ref={ref}
        {...props}
