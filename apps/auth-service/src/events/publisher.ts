 ...
 */
export async function publishUserCreated(payload: UserCreatedPayload): Promise<void> {
 ...
 */
export async function publishUserUpdated(payload: UserUpdatedPayload): Promise<void> {
  const publisher = getEventPublisher();
 ...
 */
export async function publishUserDeleted(payload: UserDeletedPayload): Promise<void> {
  const publisher = getEventPublisher();
 ...
 */
export async function publishUserLogin(payload: UserLoginPayload): Promise<void> {
  const publisher = getEventPublisher();
 ...
 */
export async function publishUserLogout(payload: UserLogoutPayload): Promise<void> {
  const publisher = getEventPublisher();
